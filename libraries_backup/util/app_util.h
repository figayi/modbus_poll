...
#define UPPER_8BITS_OF_32(a) (((a) & 0xFF000000) >> 24)
/** The lower 8 bits (of a 32 bit value) */
#define LOWER_8BITS_OF_32(a) ((a) & 0x000000FF)

/*The upper 8 bits of a 16 bit value */
#define UPPER_8BITS_OF_16(a) (((a) & 0xFF00) >> 8)
/** The lower 8 bits (of a 16 bit value) */
#define LOWER_8BITS_OF_16(a) ((a) & 0x00FF)

/*The upper 16 bits of a 32 bit value */
#define UPPER_16BITS_OF_32(a) (((a) & 0xFFFF0000) >> 16)
/** The lower 8 bits (of a 32 bit value) */
#define LOWER_16BITS_OF_32(a) ((a) & 0x0000FFFF)
